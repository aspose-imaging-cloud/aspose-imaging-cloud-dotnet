...
namespace Aspose.Imaging.Cloud.Live.Demos.UI.Config
{
    ...
    {
        private AsposeImagingCloudContext _atContext;

        /// <summary>
        /// Main context object to access all the SybContent specific context info
        /// </summary>
        public AsposeImagingCloudContext AsposeImagingCloudContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeImagingCloudContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeImagingCloudContext.atcc = AsposeImagingCloudContext;
            base.OnLoad(e);
        }
    }
}
